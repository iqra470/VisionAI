...
//       {/* 🔷 HERO SECTION */}
//       <div className="text-center py-20 px-6 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700">
...
//           Upload an image and generate an optimized AI prompt to recreate a better, 
//           more detailed version using advanced models.
//         </p>
...
//       </div>
      ...
      <div className="py-16 px-6 text-center">
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
            ...
            <p>Upload your image to start the process</p>
          </div>

          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
            <h3 className="text-xl font-semibold mb-2">🧠 Analyze</h3>
            <p>AI analyzes image using BLIP model</p>
          </div>

          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
            <h3 className="text-xl font-semibold mb-2">✨ Optimize</h3>
            <p>Generate high-quality prompt automatically</p>
          </div>

          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
            <h3 className="text-xl font-semibold mb-2">🎨 Generate</h3>
            <p>Create improved image using AI</p>
          </div>
      ...
      //   <h2 className="text-3xl font-bold mb-10">Models Used</h2>

      //   <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          
      //     <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
      //       <h3 className="text-xl font-semibold mb-2">🧠 BLIP</h3>
      //       <p>Image captioning model for understanding visuals</p>
      //     </div>

      //     <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
      //       <h3 className="text-xl font-semibold mb-2">🎨 Stable Diffusion</h3>
      //       <p>Generates high-quality images from prompts</p>
      //     </div>

      //     <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition">
      //       <h3 className="text-xl font-semibold mb-2">📊 CLIP</h3>
      //       <p>Evaluates similarity between image and prompt</p>
      //     </div>
...
//       {/* 🔷 HERO SECTION */}
//       <div className="text-center py-20 px-6 bg-gradient-to-br from-purple-400 via-blue-400 to-indigo-500 text-white">
...
//         <Link to="/dashboard">
//           <button className="bg-white text-black px-8 py-3 rounded-xl font-semibold hover:scale-105 hover:bg-gray-200 transition shadow-lg">
//             🚀 Generate Image
//           </button>
//         </Link>
//       </div>
...
//             {
//               name: "BLIP",
//               desc: "Understands image content",
